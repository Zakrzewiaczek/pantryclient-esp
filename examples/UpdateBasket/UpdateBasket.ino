/*
 * Example: UpdateBasket
 * Demonstrates how to update (merge) data in an existing basket.
 */
...
void setup()
{
    ...
    if (client.updateBasket(BASKET_NAME, updateDoc))
    {
        Serial.println("Basket updated successfully.");
    }
    else
    {
        Serial.println("Failed to update basket. Does it exist?");
    }
}
